package de.mxscha.en.endoflife.utils.scoreboard.manager.chat;
...
public enum Messages {
    ...
    TPPREFIX(TextColor.TPA_1.get() + "&lT" + TextColor.TPA_2.get() + "&lP" + TextColor.TPA_3.get() + "&LA"),
    PRFIX(TPPREFIX.get() + " &8| &f"),
